...
function Register() {
    ...
    const validateEmail = async (email) => {
      ...
      try {
        ...
        setErrors((prev) => ({ ...prev, email: "Erreur lors de la vérification. Réessayez plus tard." }));
      }
    };
    ...
    const handleManualRegister = async (e) => {
      ...
      if (response.ok) {
        ...
        setErrors((prev) => ({ ...prev, global: data.error || "Une erreur est survenue." }));
      }
    };
          ...
          <div className="flex flex-1 relative">
            ...
            <div className="flex-1 flex flex-col justify-center items-center px-8 z-10">
              <div className="max-w-md w-full">
                ...
                <span className="text-gray-300 mt-4"> Déjà un compte ? <a href="/login" className="text-blue-500 hover:text-blue-400">Login</a></span>
                </div>         
             </div>
            </div>
            ...
            <div className="flex-1 bg-blue-700 text-white flex flex-col justify-center items-center p-8 relative z-0">
              ...
              <h2 className="text-3xl font-bold mb-4">Explorez les meilleurs portfolios design</h2>
              <p className="text-gray-300 text-sm">
                Découvrez des millions de designers et agences du monde entier qui utilisent Flowbite pour partager
                leurs projets.
              </p>
